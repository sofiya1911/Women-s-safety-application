        ...
        switch (v.getId()) {
            case R.id.button2:
                if (mem.getText().toString().equals("")) {
                    ...
                    Toast.makeText(loginPage.this, "Please enter valid password", Toast.LENGTH_SHORT).show();
                } else if (mem!=null && mem.getText().toString().equals("admin@gmail.com") && mps.getText().toString().equals("admin123")) {
                    startActivity(new Intent(loginPage.this,AdminSplash.class));
                }
                                ...
                                if (task.isSuccessful()) {
                                    for (QueryDocumentSnapshot doc : task.getResult()) {
                                        ...
                                        if (a!=null && a.equals(a1) && b.equals(b1)) {
                                          ...
                                          Toast.makeText(loginPage.this, "Cannot login,incorrect Email and Password", Toast.LENGTH_SHORT).show();
                                        }
            ...
            case R.id.dontHaveAccount:
                Intent register_view = new Intent(loginPage.this, register.class);
